      ...
      >
        ...
        <motion.div variants={itemVariants} className="mt-12 text-center">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-neon text-dark-bg font-bold rounded-lg shadow-glow-purple hover:shadow-lg transition-all cursor-pointer"
          >
